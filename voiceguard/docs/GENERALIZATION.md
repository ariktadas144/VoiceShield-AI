# GENERALIZATION.md — does Indic-fine-tuned VoiceGuard generalise beyond its training corpus?
...
> **Does the existing VoiceGuard RawNet2 architecture, after Indic fine-tuning, generalise
