"""Where do the candidate generators sit relative to the data VoiceGuard already uses?
...
bonafide VoiceGuard actually trains on, and it turns out to differ from it. So the
...
This asks the question that decides the pilot instead. Five populations, one front end:
  ...
  spoof_existing   xtts_v2 / freevc24 -- the spoofs VoiceGuard already trains against
