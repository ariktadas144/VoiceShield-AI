"""Load the official ASVspoof 2021 RawNet2 checkpoint into VoiceGuard's RawNet.

WHY THIS WORKS AT ALL
---------------------
VoiceGuard's `model.py` is the official ASVspoof 2021 Baseline-RawNet2 with a second
