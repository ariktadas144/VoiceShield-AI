...
def build(name, args):
    kw = {}
    if name == "voiceshield" and args.checkpoint:
...
def evaluate(args) -> int:
    ...
    for b in args.backends:
        ...
        # calibrated operating point, so imposing VoiceShield's would be meaningless.
...
def main() -> int:
    ...
    p.add_argument("--backends", nargs="+", default=["voiceshield", "dhwani"])
