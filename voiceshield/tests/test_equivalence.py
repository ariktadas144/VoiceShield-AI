"""Prove VoiceShield's adapted RawNet is numerically identical to the official one.

The Indic adaptation initialises VoiceShield from the official ASVspoof 2021
Baseline-RawNet2 checkpoint. That is only legitimate if VoiceShield's `model.py`
